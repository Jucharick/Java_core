...
public class WorkWithFiles {
    ...
    public static void main(String[] args) throws IOException {
        writeFileContents("sample01.txt", 60);
        writeFileContents("sample02.txt", 100, 1);
        concatenate("sample01.txt", "sample02.txt", "result.txt");

        if (searchInFile("result.txt", TO_SEARCH))
            System.out.printf("Файл %s содержит искомое слово %s\n", "result.txt", TO_SEARCH);
